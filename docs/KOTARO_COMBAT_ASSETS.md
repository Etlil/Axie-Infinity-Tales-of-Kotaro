...
The player has two moves: Slash (20 damage) and Bash (5 damage, 20 shield). Raised platforms and their collisions are enabled only when the opponent is Buba. Attack selection stops combat simulation while the fighters gently bob; reduced-motion mode disables bobbing and the black flash.
